...
#SBATCH -o ../config/BlockWise-%A_%a.out
#SBATCH -e ../config/BlockWise-%A_%a.err
...
export OUTPUT_DIR=$HOME/parent/DO2/outputs/blockWise
...
cp -p $WORK_DIR/ctrl_samp1000.rds .
cp -p $WORK_DIR/BlockWise.R .
